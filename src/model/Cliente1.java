...
public class Cliente1 implements Serializable {
	...
	//bi-directional many-to-one association to TipoCliente1
	@ManyToOne
	@JoinColumn(name="tipo_cliente")
	private TipoCliente1 tipoClienteBean;
	...
	public void setCedulaReal(String cedulaReal) {
		this.cedulaReal = cedulaReal;
	}
	...
	public TipoCliente1 getTipoClienteBean() {
		return this.tipoClienteBean;
	}

	public void setTipoClienteBean(TipoCliente1 tipoClienteBean) {
